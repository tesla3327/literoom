// Combined uber-shader for adjustments + tone curve
// Merges both passes into a single compute dispatch to eliminate
// intermediate texture copy, reducing memory bandwidth by ~50%.
//
...
// ============================================================================
// Adjustment functions (from adjustments.wgsl)
// ============================================================================
...
// ============================================================================
// Tone curve functions (from tone-curve.wgsl)
// ============================================================================
